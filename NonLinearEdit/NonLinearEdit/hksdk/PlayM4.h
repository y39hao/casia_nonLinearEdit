...
PLAYM4_API BOOL __stdcall PlayM4_SetVerifyCallBack(LONG nPort, DWORD nBeginTime, DWORD nEndTime, void (__stdcall * funVerify)(long nPort, FRAME_POS * pFilePos, DWORD bIsVideo, void* nUser),  void* nUser);
PLAYM4_API BOOL __stdcall PlayM4_SetAudioCallBack(LONG nPort, void (__stdcall * funAudio)(long nPort, char * pAudioBuf, long nSize, long nStamp, long nType, void* nUser), void* nUser);
...
PLAYM4_API BOOL __stdcall PlayM4_GetOriginalFrameCallBack(LONG nPort, BOOL bIsChange,BOOL bNormalSpeed,long nStartFrameNum,long nStartStamp,long nFileHeader,void(CALLBACK *funGetOrignalFrame)(long nPort,FRAME_TYPE *frameType, void* nUser),void* nUser);
...
PLAYM4_API BOOL __stdcall PlayM4_GetThrowBFrameCallBack(LONG nPort,void(CALLBACK* funThrowBFrame)(long nPort,DWORD nBFrame,void* nUser),void* nUser);
...
PLAYM4_API BOOL __stdcall PlayM4_SetGetUserDataCallBack(LONG nPort,void(CALLBACK* funGetUserData)(long nPort,BYTE *pUserBuf,DWORD nBufLen,void* nUser),void* nUser);
...
PLAYM4_API BOOL __stdcall PlayM4_SetDecCallBackExMend(LONG nPort, void (CALLBACK* DecCBFun)(long nPort, char* pBuf, long nSize, FRAME_INFO* pFrameInfo, 
													  void* nUser, void* nReserved2), char* pDest, long nDestSize, void* nUser);
...
#define R_ANGLE_0   0xffffffff  //不旋转
...
typedef struct
{
	...
	DWORD dwPicSize;      //实际图片大小[out]
	DWORD dwBufSize;      //数据buffer大小
	DWORD dwPicWidth;	  //截图宽[out]
	DWORD dwPicHeight;    //截图高[out]
	DWORD dwReserve;      //多加一个reserve字段
	RECT  *pCropRect;     //选择区域NULL, 同老的抓图接口
}CROP_PIC_INFO;
#endif

PLAYM4_API BOOL __stdcall PlayM4_GetCropJPEG(LONG nPort, CROP_PIC_INFO *pstPicInfo);
PLAYM4_API BOOL __stdcall PlayM4_GetCropBMP(LONG nPort, CROP_PIC_INFO *pstPicInfo);
